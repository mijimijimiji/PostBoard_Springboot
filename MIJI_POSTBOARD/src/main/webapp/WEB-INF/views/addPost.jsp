		 ...
		 //CKEditor를 textarea와 연결했음. 그래서 id가 textarea의 ID임
			...
			function MyUploadAdapter(loader) {
			 ...
			 $("#back").on("click", function(){
				 ...
				 $("#addPostForm").attr("action","/app").submit();
...
<h2>커뮤니티 글쓰기</h2>
<hr>
<form id="addPostForm" action="addPost" enctype="multipart/form-data">
...
<input type="hidden" name="postDate" value=" "> mapper단에서 sysdate처리 
<input type="hidden" name="postEditDate" value=" "> null
...
<table border="1" style="width: 700px" align="center">
	<tr>
		<td colspan="3" align="center">
			<input type="text" name="postTitle" placeholder="제목을 입력하세요." style="width: 700px">
		</td>
	</tr>	
	<tr>
		<td><textarea style="width: 700px; height: 400px;" placeholder="내용을 입력하세요." name="postText" id="postText"></textarea></td>
	</tr>
	<tr>
	<td colspan="3" align="center">
	<input type="submit" id="add" value="등록"></input>
